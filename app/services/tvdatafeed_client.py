# tvdatafeed_client.py
# Vendored and adapted from: https://github.com/rongardF/tvdatafeed
# License: MIT
...
class TvDatafeed:
    """TradingView Data Feed Client (Vendored)"""
    ...
    def __init__(self, username: str = None, password: str = None) -> None:
        """Create TvDatafeed object (No login by default for public data)"""
        self.ws_debug = False
    ...
    def __auth(self, username, password):
        """Authenticate with TradingView (optional)"""
